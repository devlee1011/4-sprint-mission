...
public class BasicBinaryContentService implements BinaryContentService {
    ...
    public void delete(UUID binaryContentId) {
        ...
        checkBinaryContentIsExist(binaryContentId);
    ...
    @Override
    public BinaryContentDto updateStatus(UUID binaryContentId, BinaryContentStatus newBinaryContentStatus) {
        ...
        log.info("바이너리 컨텐츠 상태 업데이트 완료: id={}, newStatus={}", binaryContentId, dto.status().name());
        return dto;
    }
